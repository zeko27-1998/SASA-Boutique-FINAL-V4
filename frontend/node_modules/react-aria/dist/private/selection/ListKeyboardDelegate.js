...
class $abb04fbee71f000f$export$a05409b8bb224a5a {
    isDisabled(item) {
        ...
        return this.disabledBehavior === 'all' && (((_item_props = item.props) === null || _item_props === void 0 ? void 0 : _item_props.isDisabled) || this.disabledKeys.has(item.key)) && ((_item_props1 = item.props) === null || _item_props1 === void 0 ? void 0 : _item_props1.disabledBehavior) !== 'selection';
    }
    findNextNonDisabled(key, getNext, includeDisabled = false) {
        let nextKey = key;
        while(nextKey != null){
            let item = this.collection.getItem(nextKey);
            if ((item === null || item === void 0 ? void 0 : item.type) === 'item' && (includeDisabled || !this.isDisabled(item))) return nextKey;
    ...
    getNextKey(key, options) {
        ...
        return this.findNextNonDisabled(nextKey, (key)=>this.collection.getKeyAfter(key), options === null || options === void 0 ? void 0 : options.includeDisabled);
    }
    getPreviousKey(key, options) {
        let nextKey = key;
        nextKey = this.collection.getKeyBefore(nextKey);
        return this.findNextNonDisabled(nextKey, (key)=>this.collection.getKeyBefore(key), options === null || options === void 0 ? void 0 : options.includeDisabled);
    }
    ...
    getKeyRightOf(key, options) {
        ...
        if (this.layoutDelegate[layoutDelegateMethod]) {
            ...
            return this.findNextNonDisabled(key, (key)=>this.layoutDelegate[layoutDelegateMethod](key), options === null || options === void 0 ? void 0 : options.includeDisabled);
        }
        if (this.layout === 'grid') {
    ...
    constructor(...args){
        if (args.length === 1) {
            ...
            this.layoutDelegate = opts.layoutDelegate || new (0, $b97f9e0227e72afb$export$8f5ed9ff9f511381)(opts.ref);
        } else {
            ...
            this.layoutDelegate = new (0, $b97f9e0227e72afb$export$8f5ed9ff9f511381)(this.ref);
        }
...
export {$abb04fbee71f000f$export$a05409b8bb224a5a as ListKeyboardDelegate};
//# sourceMappingURL=ListKeyboardDelegate.js.map
